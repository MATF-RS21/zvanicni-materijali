...
int main()
{
    // "Obicna" baza se moze kopirati
    const database db1("http://sql.matf.bg.ac.rs/");
    const auto db1_copy = db1; // Poziv konstruktora kopije! (nema ispisa "povezivanja" u terminalu)

    const internal_database db2;
