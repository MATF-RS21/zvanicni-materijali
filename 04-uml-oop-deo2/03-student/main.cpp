...
public:
    master_student(const std::string &name, const Studies Studies, const std::string &thesis, const std::string &mentor)
        : student(name, Studies) // Pozivanje konstruktora bazne klase
        , m_thesis(thesis), m_mentor(mentor) // Inicijalizacija ostalih atributa
    {
    }
...
int main()
{
    ...
    master_student s2("Janka Jankovic", Studies::Informatics, "Plan 9 FS", "Mirko Mirkovic");
