...
namespace matf
{
    ...
    public:
        ...
        // i konstruktor kopije i operator dodele sa semantikom kopiranja (rule of 3),
        // ili ih eksplicitno izbrisati (navodjenjem "= delete" nakon metoda),
        // a pozeljno je napraviti i konstruktor pomeranja i operator dodele
    ...
    private:
        ...
        // Inicijalne vrednosti za atribute klase -> zamena za inicijalizatorsku listu u konstruktoru
